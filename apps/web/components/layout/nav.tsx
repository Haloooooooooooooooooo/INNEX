...
export function Nav() {
  ...
  return (
    ...
    >
      <div className="px-[30px] pt-[46px] pb-7 border-b border-white/6">
        <div
          className="text-[34px] font-black text-white tracking-tight scale-x-[0.94] origin-left"
          style={{ fontFamily: "'Bebas Neue', sans-serif" }}
        >
          INN<span className="text-[--innex-accent]">EX</span>
        </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`flex items-center gap-4 px-[30px] py-5 cursor-pointer transition-all duration-150 border-l-[3px] border-l-transparent relative ${
                isActive
                  ? "border-l-[--innex-accent]"
      ...
      <div className="px-[30px] pb-[30px] pt-0 border-t border-white/6">
